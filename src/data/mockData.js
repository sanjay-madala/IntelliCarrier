...
export const lpgCols = [
  ...
  { key: 'salesNo',         label: 'Sales No.',            labelTh: 'เลขที่ขาย',          show: false },
  { key: 'poNo',            label: 'PO No.',               labelTh: 'เลขที่ใบสั่งซื้อ',    show: false },
  { key: 'refNo',           label: 'Ref No.',              labelTh: 'เลขที่อ้างอิง',      show: false },
  { key: 'billingDate',     label: 'Billing Date',         labelTh: 'วันที่เรียกเก็บ',    show: true },
  { key: 'shippingType',    label: 'Shipping Type',        labelTh: 'ประเภทการขนส่ง',     show: false },
  { key: 'productType',     label: 'Product Type',         labelTh: 'ชนิดสินค้า',         show: false },
  { key: 'routeName',       label: 'Route Name',           labelTh: 'ชื่อเส้นทาง',        show: false },
  ...
  { key: 'grandTotal',      label: 'Grand Total',          labelTh: 'ยอดรวมทั้งสิ้น',     show: false },
  { key: 'status',          label: 'Status',               labelTh: 'สถานะ',              show: false },
  { key: 'change',          label: 'Change',               labelTh: 'เปลี่ยนแปลง',        show: false },
  { key: 'distCode',        label: 'Dist. Code',           labelTh: '[รหัส]ระยะทาง',      show: false },
...
export const ngvCols = [
  ...
  { key: 'monthly',         label: 'Monthly',              labelTh: 'รายเดือน',            show: true },
  { key: 'totalCost',       label: 'Total Cost',           labelTh: 'ค่าใช้จ่ายรวม',      show: true },
  { key: 'tripCount',       label: 'Trip Count',           labelTh: 'จำนวนเที่ยว',        show: true },
  { key: 'totalDist',       label: 'Total Dist',           labelTh: 'ระยะทางรวม',         show: true },
...
export const awaitingRows = [
  { id: 'AW001', shipmentNo: 'SHP-2026-004', stage: 'S1', product: 'LPG', soldTo: '1000001', soldToName: 'หจก.ตั้งไพบูลย์ ปิโตรเลียม', shipTo: '2000001', shipToName: 'สาขาขอนแก่น', custDoc: 'CD-20260201', docDate: '2026-02-13', ticketQty: 15000, actualQty: 14850, billingQty: 14850, salesNo: '', poNo: 'PO-2026-0041', refNo: 'REF-001', billingDate: '2026-02-13', shippingType: '01', productType: 'LPG', routeName: 'BTC-ขอนแก่น-BTC', vehicleType: 'LPG Tanker', vehicleAge: 5, distance: 480, billingDist: 480, actualDist: 478, fuelPrice: 32.50, fuel025: 8.13, fuel050: 16.25, fuel100: 32.50, cannotUnload: false, tripNo: 'T001', serviceCode: '7SLLTRNSPT000004', wbs: 'WBS-001', route: '0C3415', plate: '2กค-5678', trailer: 'TRL-002', driver: 'อนุชา บุญมาก', qtyDiff: -150, distDiff: -2, ratePerKm: 12.50, totalFreight: 6000, fuelSurcharge: 300, otherCharge: 0, grandTotal: 6300, statusField: 'Open', change: '', distCode: '0C3415', status: 'awaiting' },
  { id: 'AW002', shipmentNo: 'SHP-2026-004', stage: 'S2', product: 'LPG', soldTo: '1000002', soldToName: 'หจก.เอส พนมยงค์', shipTo: '2000002', shipToName: 'คลังโคราช', custDoc: 'CD-20260202', docDate: '2026-02-13', ticketQty: 8000, actualQty: 7950, billingQty: 7950, salesNo: '', poNo: 'PO-2026-0042', refNo: 'REF-002', billingDate: '2026-02-13', shippingType: '01', productType: 'LPG', routeName: 'BTC-โคราช-BTC', vehicleType: 'LPG Tanker', vehicleAge: 5, distance: 300, billingDist: 300, actualDist: 298, fuelPrice: 32.50, fuel025: 8.13, fuel050: 16.25, fuel100: 32.50, cannotUnload: true, tripNo: 'T002', serviceCode: '7SLLTRNSPT000004', wbs: 'WBS-001', route: '0C3415', plate: '2กค-5678', trailer: 'TRL-002', driver: 'อนุชา บุญมาก', qtyDiff: -50, distDiff: -2, ratePerKm: 11.00, totalFreight: 3300, fuelSurcharge: 150, otherCharge: 0, grandTotal: 3450, statusField: 'Open', change: '', distCode: '0C3415', status: 'awaiting' },
  { id: 'AW003', shipmentNo: 'SHP-2026-010', stage: 'S3', product: 'LPG', soldTo: '1000005', soldToName: 'บจก.ไชยโชติช่วง', shipTo: '2000005', shipToName: 'สาขาชุมพร', custDoc: 'CD-20260203', docDate: '2026-02-15', ticketQty: 12000, actualQty: 11900, billingQty: 11900, salesNo: '', poNo: 'PO-2026-0043', refNo: 'REF-003', billingDate: '2026-02-15', shippingType: '01', productType: 'LPG', routeName: 'MTP-ชุมพร-MTP', vehicleType: 'LPG Tanker', vehicleAge: 5, distance: 440, billingDist: 440, actualDist: 438, fuelPrice: 33.00, fuel025: 8.25, fuel050: 16.50, fuel100: 33.00, cannotUnload: false, tripNo: 'T003', serviceCode: '7SLLTRNSPT000004', wbs: 'WBS-002', route: '0C2801', plate: '2กค-5678', trailer: 'TRL-002', driver: 'สมชาย พลเดช', qtyDiff: -100, distDiff: -2, ratePerKm: 13.00, totalFreight: 5720, fuelSurcharge: 280, otherCharge: 100, grandTotal: 6100, statusField: 'Open', change: '', distCode: '0C2801', status: 'awaiting' },
  { id: 'AW004', shipmentNo: 'SHP-2026-001', stage: 'S1', product: 'LPG', soldTo: '1000001', soldToName: 'หจก.ตั้งไพบูลย์ ปิโตรเลียม', shipTo: '2000006', shipToName: 'สาขานครราชสีมา', custDoc: 'CD-20260204', docDate: '2026-02-17', ticketQty: 18000, actualQty: 17800, billingQty: 17800, salesNo: '', poNo: 'PO-2026-0044', refNo: 'REF-004', billingDate: '2026-02-17', shippingType: '01', productType: 'LPG', routeName: 'BTC-นครราชสีมา-BTC', vehicleType: 'LPG Tanker', vehicleAge: 3, distance: 120, billingDist: 120, actualDist: 119, fuelPrice: 32.50, fuel025: 8.13, fuel050: 16.25, fuel100: 32.50, cannotUnload: false, tripNo: 'T004', serviceCode: '7SLLTRNSPT000004', wbs: 'WBS-003', route: '0C3415', plate: '1กข-1234', trailer: 'TRL-001', driver: 'สมชาย พลเดช', qtyDiff: -200, distDiff: -1, ratePerKm: 10.00, totalFreight: 1200, fuelSurcharge: 60, otherCharge: 0, grandTotal: 1260, statusField: 'Open', change: '', distCode: '0C3415', status: 'awaiting' },
  { id: 'AW005', shipmentNo: 'SHP-2026-008', stage: 'S1', product: 'LPG', soldTo: '1000006', soldToName: 'บจก.ศรีราชา แก๊ส', shipTo: '2000007', shipToName: 'คลังปากช่อง', custDoc: 'CD-20260205', docDate: '2026-02-16', ticketQty: 20000, actualQty: 19800, billingQty: 19800, salesNo: '', poNo: 'PO-2026-0045', refNo: 'REF-005', billingDate: '2026-02-16', shippingType: '01', productType: 'LPG', routeName: 'BTC-ปากช่อง-BTC', vehicleType: 'LPG Tanker', vehicleAge: 3, distance: 180, billingDist: 180, actualDist: 179, fuelPrice: 33.00, fuel025: 8.25, fuel050: 16.50, fuel100: 33.00, cannotUnload: true, tripNo: 'T005', serviceCode: '7SLLTRNSPT000004', wbs: 'WBS-003', route: '0C2801', plate: '1กข-1234', trailer: 'TRL-001', driver: 'อดิศร วงศ์สุวรรณ', qtyDiff: -200, distDiff: -1, ratePerKm: 11.50, totalFreight: 2070, fuelSurcharge: 100, otherCharge: 50, grandTotal: 2220, statusField: 'Open', change: '', distCode: '0C2801', status: 'awaiting' },
  { id: 'AW006', shipmentNo: 'SHP-2026-009', stage: 'S1', product: 'NGV', soldTo: '1000003', soldToName: 'บจก.ปตท. จำหน่ายก๊าซ', shipTo: '2000003', shipToName: 'สถานี NGV โคราช', soShipment: 'SHP-2026-009', item: 'NGV-001', material: 'NGV Compressed', transportRate: 2.50, distance: 180, gasQty: 3800, stationCost: 1200, monthly: 36000, totalCost: 10700, tripCount: 30, totalDist: 5400, distCategory: '≤200km', rateInput: 2.50, docDate: '2026-02-14', billingDate: '2026-02-14', status: 'awaiting' },
